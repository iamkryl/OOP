...
class QuestOne {
    public void startQuest() {
        ...
        int kamadHealth = 250;
        int kamadMaxHealth = 250;
        int kamadMana = 200;
        int kamadMaxMana = 200;
        ...
        for (int i = 0; i < enemies.length; i++) {
            ...
            switch (upgradeChoice) {
                case 1:
                    kamadMaxHealth += 50;
                    kamadHealth += 50;
                    simulateTyping("Kamadan increases her MAXIMUM HEALTH! New MAXIMUM HEALTH: " + kamadMaxHealth + " ");
                    break;
                case 2:
                    kamadMaxMana += 50;
                    kamadMana += 50;
                    simulateTyping("Kamadan increases her MAXIMUM MANA! New MAXIMUM MANA: " + kamadMaxMana + " ");
                    break;
                default:
